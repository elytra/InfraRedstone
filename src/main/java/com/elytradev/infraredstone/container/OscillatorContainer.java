...
import com.elytradev.infraredstone.container.widget.WButton;
...
public class OscillatorContainer extends ConcreteContainer {
    ...
    public OscillatorContainer(IInventory player, IInventory container, TileEntityOscillator oscillator) {
        ...
        setRootPanel(panel);
        WButton plusOneTick = new WButton(tick_up, dummy_off, this::sendOneTick).withTooltip("Increase by 0.1 seconds");
        WButton plusOneSecond = new WButton(second_up, dummy_off, this::sendOneSecond).withTooltip("Increase by 1 second");
        WButton minusOneTick = new WButton(tick_down, dummy_off, this::sendOneTickDown).withTooltip("Decrease by 0.1 seconds");
        WButton minusOneSecond = new WButton(second_down, dummy_off, this::sendOneSecondDown).withTooltip("Decrease by 1 second");
