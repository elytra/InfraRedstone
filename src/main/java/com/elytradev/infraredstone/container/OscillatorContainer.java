...
import com.elytradev.infraredstone.container.widget.WSilentButton;
...
public class OscillatorContainer extends ConcreteContainer {
    ...
    public OscillatorContainer(IInventory player, IInventory container, TileEntityOscillator oscillator) {
        ...
        setRootPanel(panel);
        WSilentButton plusOneTick = new WSilentButton(tick_up, dummy_off, this::sendOneTick).withTooltip("Increase by 0.1 seconds");
        WSilentButton plusOneSecond = new WSilentButton(second_up, dummy_off, this::sendOneSecond).withTooltip("Increase by 1 second");
        WSilentButton minusOneTick = new WSilentButton(tick_down, dummy_off, this::sendOneTickDown).withTooltip("Decrease by 0.1 seconds");
        WSilentButton minusOneSecond = new WSilentButton(second_down, dummy_off, this::sendOneSecondDown).withTooltip("Decrease by 1 second");
