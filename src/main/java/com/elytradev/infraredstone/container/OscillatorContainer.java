...
import com.elytradev.infraredstone.container.widget.WProxySoundButton;
...
public class OscillatorContainer extends ConcreteContainer {
    ...
    public OscillatorContainer(IInventory player, IInventory container, TileEntityOscillator oscillator) {
        ...
        setRootPanel(panel);
        WProxySoundButton plusOneTick = new WProxySoundButton(tick_up, dummy_off, this::sendOneTick).withTooltip("Increase by 0.1 seconds");
        WProxySoundButton plusOneSecond = new WProxySoundButton(second_up, dummy_off, this::sendOneSecond).withTooltip("Increase by 1 second");
        WProxySoundButton minusOneTick = new WProxySoundButton(tick_down, dummy_off, this::sendOneTickDown).withTooltip("Decrease by 0.1 seconds");
        WProxySoundButton minusOneSecond = new WProxySoundButton(second_down, dummy_off, this::sendOneSecondDown).withTooltip("Decrease by 1 second");
